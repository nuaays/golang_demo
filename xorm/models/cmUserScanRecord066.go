...
type CmUserScanRecord066 struct {
	...
	Disabled   int       `json:"disabled" xorm:"default 0 index index(pd) INT(11)"`
	CreatedAt2 time.Time `json:"created_at2" xorm:"default 'CURRENT_TIMESTAMP' DATETIME"`
